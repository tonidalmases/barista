...
export const TEMPLATE_REPLACEMENTS: TemplateReplacementList[] = [
  {
    ...
    replacement: (content) =>
      replaceHtmlAttribute(
        'aria-label-close',
        'ariaLabelClose',
        // TODO: check the list of all elements if nothing is missing
  ...
  },
  {
    ...
    replacement: 'ariaLabelLeftHandle',
  },
  {
    needle: 'aria-label-right-handle',
    replacement: 'ariaLabelRightHandle',
  },
  {
    needle: 'aria-label-selected-area',
    replacement: 'ariaLabelSelectedArea',
  },
  {
  ...
  },
  {
    ...
    replacement: 'ariaLabelCancel',
  },
  {
    needle: 'aria-label-save',
    replacement: 'ariaLabelSave',
  },
  {
    needle: 'aria-label=',
    replacement: (content) =>
